...
def create_toy_surgwmbench(root: str | Path, num_clips: int = 2) -> Path:
    ...
    (root / "videos" / "video_01" / "video_left.avi").write_bytes(b"synthetic video placeholder")
    ...
    _write_json(root / "metadata" / "source_videos.json", [{"source_video_id": source_video_id, "source_video_path": source_video_path}])
